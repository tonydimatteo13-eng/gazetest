...
/// After the CalibrationDelegate.onCalibrationNextPoint() is called,
/// the UI is displayed at the corresponding coordinates to inform you to start collecting samples for calibration.
/// <ul>
///   <li>
